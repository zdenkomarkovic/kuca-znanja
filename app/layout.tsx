...
export const metadata: Metadata = {
  ...
  description: "Kuća znanja na Vračaru – sigurno i kreativno okruženje za decu od 7 do 15 godina. Podrška u učenju, jezici, umetnost i razvoj kreativnosti.",
  icons: {
    icon: "/android-chrome-192x192.png",
    apple: "/apple-touch-icon.png",
  },
  keywords: ["kuća znanja vračar", 
 "kuca znanja beograd", 
