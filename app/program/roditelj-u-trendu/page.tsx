        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <Card
                key={index}
                className="border-2 shadow-md shadow-primary hover:shadow-xl transition-shadow duration-300 border-primary text-center"
              >
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-white to-[#f1f1f1]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-2 shadow-md shadow-primary hover:shadow-xl transition-shadow duration-300 border-primary text-center">
              <CardContent className="p-3">
