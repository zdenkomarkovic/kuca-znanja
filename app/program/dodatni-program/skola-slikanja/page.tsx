...
export default function SkolaSlikanjaPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      />
      {/* Organizacija */}
      <section className="py-16 px-4 bg-gradient-to-br from-white to-[#f1f1f1] overflow-hidden">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="border shadow-md shadow-primary hover:shadow-xl transition-shadow duration-300 border-primary">
              <CardHeader>
                <CardTitle className="text-center text-primary">Raspored časova</CardTitle>
              </CardHeader>
            ...
            <Card className="border h-full shadow-md shadow-primary hover:shadow-xl transition-shadow duration-300 border-primary">
              <CardHeader>
                <CardTitle className="text-center text-primary">Predavač</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <Card 
                className="border shadow-md shadow-primary hover:shadow-xl transition-shadow duration-300 border-primary text-center"
              >
                <CardContent className="p-3">
                  <div className="flex justify-center mb-2">{nivo.icon}</div>
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-white to-[#f1f1f1]">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <Card className="border h-full shadow-md shadow-primary hover:shadow-xl transition-shadow duration-300 border-primary">
              <CardHeader>
                <CardTitle className="text-center text-primary">Materijal</CardTitle>
              </CardHeader>
              <CardContent>
                <p>
